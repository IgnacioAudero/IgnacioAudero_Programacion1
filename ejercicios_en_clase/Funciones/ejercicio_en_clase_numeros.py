...
while(True):
    ...
    if number == 0:
        ...
        print(f'La suma de los digitos es: {ejercicios_en_clase_fc.addition_digit(number)}')

print(f'La suma de todos los numeros ingresados es: {numbers_addition}')
print(f'La suma de los digitos de la suma de todos los numeros ingresados es: {ejercicios_en_clase_fc.addition_digit(numbers_addition)}')